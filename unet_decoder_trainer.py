...
class Decoder:
    def __init__(self, args):
        ...
        self.num_layers = args.net_layer_num
    ...
    def prepare_Model(self, model):
        ...
        #resnet
        self.resnet_part1, self.resnet_part2, self.resnet_part3 = model(self.device, self.IsEncrypt, self.dim, self.double_filter,
    ...
    def prepare_Dataset(self):
        ...
        training_set = datasets.CIFAR10(root=self.data_path, train=True,
        ...
        val_set = datasets.CIFAR10(root=self.data_path, train=False, transform=transforms.Compose([transforms.ToTensor(),
                                                                                              normalize]),
                                   download=True)
    ...
    def work(self):
        ...
        for epoch in range(0, self.num_epoch):
            ...
            print("Origin_imgs, len=%d, [0] len=%d"%(len(Origin_imgs), len(Origin_imgs[0]))) #debug
...
def main():
    ...
    if "lenet" in args.result_path:
        decoder.prepare_Model(Get_Model_Lenet)
    elif "resnet" in args.result_path:
        decoder.prepare_Model(Get_Model_ResNet)
