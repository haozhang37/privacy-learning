...
class Privacy_Trainer:
    def __init__(self, args):
        ...
        self.dim = args.dim # rqh 0514 add
...
def main():
    ...
    # parser.add_argument("--milestone", default=[20, 40], type=list)
    parser.add_argument("--result-path", default="resnet56_cifar10", type=str)
    ...
    parser.add_argument("--G-lr", default=1e-4, type=float)
    ...
    if "lenet" in args.result_path:
        args.milestone = [20, 40]
    elif "resnet" in args.result_path:
        args.milestone = [40, 80]
    ...
    if "lenet" in args.result_path:
        trainer.prepare_Model(Get_Model_Lenet, optim.SGD, optim.RMSprop, nn.CrossEntropyLoss)
    else:
    ...
    trainer.prepare_Dataset(train_set=datasets.CIFAR10, val_set=datasets.CIFAR10,
                            train_subpath=os.path.join("data", "cifar"),
                            val_subpath=os.path.join("data", "cifar"),
