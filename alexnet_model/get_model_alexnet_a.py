...
from alexnet_model.alexnet_a import alexnet_part1
from alexnet_model.alexnet_a import alexnet_part2
from alexnet_model.alexnet_a import alexnet_part3

def Get_Model_AlexNet_a(gpu_id, isEncrypt, dim, num_classes=40):
