...
from alexnet_model.alexnet_c import alexnet_part1
from alexnet_model.alexnet_c import alexnet_part2
from alexnet_model.alexnet_c import alexnet_part3

def Get_Model_AlexNet_c(gpu_id, isEncrypt, dim, num_classes=40):
    alex_part1 = alexnet_part1()
    alex_part2 = alexnet_part2(isEncrypt, dim)
    alex_part3 = alexnet_part3(num_classes)
    use_gpu = torch.cuda.is_available()
    if use_gpu:
        # alex_part1 = alex_part1.cuda()
        # alex_part2 = alex_part2.cuda()
        # alex_part3 = alex_part3.cuda()
        print("###########Using GPU!!!##########")
