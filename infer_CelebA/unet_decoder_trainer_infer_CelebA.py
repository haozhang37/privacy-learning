...
class Decoder:
    def __init__(self, args):
        ...
        if self.decoder_type == 1:
            ...
            self.model_path = os.path.join(self.result_path, 'net_normal3')
        ...
        #dataset param
        self.cifar10_mean = [0.5, 0.5, 0.5]
        self.cifar10_std = [0.5, 0.5, 0.5]
    ...
    def saveImg(self,epoch, Origin_imgs,Decoder_img): # Origin_imgs: (dim, visual_num)
        visual_path = os.path.join(self.sub_decoder_path, str(epoch))
...
def main():
    ...
    parser.add_argument("--net-layer-num", default=110, type=int)
