...
def main():
    ...
    # parser.add_argument("--dataset-path", default="data/oracle", type=str)
    parser.add_argument("--sub-result-path", default="eval_best_sample", type=str)
    ...
    trainer.prepare_Dataset(train_set=ourDataset, val_set=ourDataset,
                            train_subpath="/data/CelebA_best_img_dim%d" % args.dim,
                            val_subpath="/data/CelebA_best_img_dim%d" % args.dim,
