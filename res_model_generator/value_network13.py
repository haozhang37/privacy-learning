...
from res_model_generator.resnet13 import GoResNet13

class Model_Resnet13(Model13):
    ...
    def __init__(self,board_size,num_input_channels,num_block,kernel_size):
        ...
        self.value_final_conv = self._conv_layer_norelu(224, self.num_input_channels, 1)
        ...
        self.tanh = nn.Tanh()
        self.resnet = GoResNet13(num_block,kernel_size)
